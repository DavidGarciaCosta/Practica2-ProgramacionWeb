 ...
 * Type: UI
 * Evidence summary: pages=/register selectors=#acceptTerms, #confirmPassword, #email, #errorMessage, #newsletter, #password, #sendMessage, #successMessage, #username, [name="role"] messages=Error al actualizar rol, Inicio de sesión exitoso, Error al actualizar stock
 */

describe("Disponibilidad de mutación createOrder", () => {
  it("Disponibilidad de mutación createOrder", () => {
