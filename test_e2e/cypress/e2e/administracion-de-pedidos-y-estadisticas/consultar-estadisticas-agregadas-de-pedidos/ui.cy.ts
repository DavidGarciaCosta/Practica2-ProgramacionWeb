 ...
 * Type: UI
 * Evidence summary: pages=/register selectors=#acceptTerms, #confirmPassword, #email, #errorMessage, #newsletter, #password, #successMessage, #total, #username, [name="role"] messages=Error al actualizar rol, Rol actualizado exitosamente, Error al actualizar estado del pedido
 */

describe("Consultar estadísticas agregadas de pedidos", () => {
  it("Consultar estadísticas agregadas de pedidos", () => {
