 ...
 * Type: UI
 * Evidence summary: pages=/register selectors=#acceptTerms, #adminLink, #confirmPassword, #email, #errorMessage, #newsletter, #password, #successMessage, #username, [name="role"] messages=Error al actualizar rol, Rol actualizado exitosamente, Inicio de sesión exitoso
 */

describe("Usuario no-admin no puede listar pedidos (orders)", () => {
  it("Usuario no-admin no puede listar pedidos (orders)", () => {
